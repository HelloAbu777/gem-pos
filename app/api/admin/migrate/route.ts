...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    await prisma.$executeRawUnsafe(`CREATE TABLE IF NOT EXISTS "products" ("id" TEXT NOT NULL, "name" TEXT NOT NULL, "barcode" TEXT, "unit" TEXT NOT NULL DEFAULT 'dona', "quantity" DOUBLE PRECISION NOT NULL DEFAULT 0, "minQuantity" DOUBLE PRECISION NOT NULL DEFAULT 10, "purchasePrice" DOUBLE PRECISION NOT NULL, "salePrice" DOUBLE PRECISION NOT NULL, "margin" DOUBLE PRECISION NOT NULL, "vatType" "VATType" NOT NULL DEFAULT 'NO_VAT', "expiryDate" TIMESTAMP(3), "isPinned" BOOLEAN NOT NULL DEFAULT false, "categoryId" TEXT NOT NULL, "supplierId" TEXT NOT NULL, "branchId" TEXT NOT NULL, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "products_pkey" PRIMARY KEY ("id"));`);
    await prisma.$executeRawUnsafe(`CREATE UNIQUE INDEX IF NOT EXISTS "products_barcode_key" ON "products"("barcode");`);
    // isPinned column mavjud jadvalga ham qo'shamiz
    await prisma.$executeRawUnsafe(`ALTER TABLE "products" ADD COLUMN IF NOT EXISTS "isPinned" BOOLEAN NOT NULL DEFAULT false;`);
    steps.push('products');
